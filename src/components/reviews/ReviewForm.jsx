...
const ReviewForm = (props) => {
  ...
  const submitHandler = (event) => {
    ...
    const newRating = (numOfReviews * currentRating + rating) / (numOfReviews + 1)
  ...
  return (
    <Fragment>
      <form onSubmit={submitHandler}>
        <div className="d-flex flex-column align-items-center gap-3 my-4 mx-auto">
          <h4>Your Review</h4>
          <div className="d-flex align-items-center gap-3">
            <span className="fs-4">Your Rating</span>
